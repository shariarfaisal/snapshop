...
export default function EditMedicalRecordPage() {
  ...
  const { getStudentById, getStudentMedical, updateMedicalRecord } = useStudent();
  ...
  if (isStudentLoading || isMedicalLoading) {
    return (
    ...
    return (
      <div className="container mx-auto p-6">
        <div className="text-center py-10">
          ...
          <p className="mt-2">This student doesn't have a medical record yet.</p>
          <Button 
            variant="link" 
            className="mt-4"
            onClick={() => router.push(`/admin/students/${studentId}/medical/create`)}
          >
    ...
    <div className="container mx-auto p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update medical information for this student
          </CardDescription>
        </CardHeader>
        <CardContent>
          <StudentMedicalForm 
            ...
            submitLabel="Update Medical Record"
