  ...
  const contentSections = [
    {
      ...
      icon: Settings,
      href: '/admin/settings/content/site',
      color: 'bg-blue-500',
    },
    {
      title: 'Landing Page',
      ...
      icon: Layout,
      href: '/admin/settings/content/landing-page',
      color: 'bg-green-500',
    },
    {
      title: 'About Page',
      ...
      icon: Info,
      href: '/admin/settings/content/about-page',
      color: 'bg-purple-500',
    },
    {
      title: 'FAQs',
      ...
      icon: HelpCircle,
      href: '/admin/settings/content/faqs',
      color: 'bg-orange-500',
    },
    {
      ...
      icon: FileText,
      href: '/admin/settings/content/help-resources',
      color: 'bg-pink-500',
    },
    {
      ...
      icon: Navigation,
      href: '/admin/settings/content/navigation',
      color: 'bg-indigo-500',
    },
    {
      title: 'SEO Settings',
      ...
      icon: Search,
      href: '/admin/settings/content/seo',
      color: 'bg-teal-500',
    },
  ];
