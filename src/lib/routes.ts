...
export const ROUTES = {
  ...
  ADMIN_EXAMS_ROOMS: "/admin/exams/rooms",
  ADMIN_EXAMS_PARTICIPANTS: "/admin/exams/participants",
  ADMIN_EXAMS_SEAT_PLAN: "/admin/exams/seat-plan",
  ADMIN_EXAMS_ADMIT_CARDS: "/admin/exams/admit-cards",
  ADMIN_EXAMS_MERIT_LIST: "/admin/exams/merit-list",
  ADMIN_EXAMS_SCHEDULE: "/admin/exams/schedule",
  ADMIN_EXAMS_RESULTS: "/admin/exams/results",
