...
import { LayoutDashboard, DollarSign, FileText, TrendingUp, Menu, X } from "lucide-react";
...
const navigation = [
  ...
  { name: "Reports", href: "/accountant/reports", icon: TrendingUp },
];
    ...
    <div className="flex h-screen bg-gray-100">
      ...
      <aside className={cn(
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b">
          <h1 className="text-xl font-bold text-gray-900">Accountant</h1>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-16 bg-white shadow-sm">
          <div className="h-full px-4 flex items-center justify-between">
            ...
            <span className="text-sm text-gray-700">Accountant Portal</span>
          </div>
        </header>
